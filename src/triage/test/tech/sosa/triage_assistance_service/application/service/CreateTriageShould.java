...
public class CreateTriageShould extends TestWithUtils {
    ...
    public void execute_correctly_with_valid_arguments() throws IOException, URISyntaxException {
        ...
        assertNull(triageRepo.find(new ChiefComplaint(new ChiefComplaintId("SCTID:999"))));
        ...
        assertNotNull(triageRepo.find(new ChiefComplaint(new ChiefComplaintId("SCTID:999"))));
    }
